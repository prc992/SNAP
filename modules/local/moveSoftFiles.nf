process moveSoftFiles {
    ...
    find ${workflow.projectDir}/${params.outputFolder}/reports/multiqc/ -type f ! ( -name "*.html" -o -name "*.jpg" ) -exec mv {} ${workflow.projectDir}/${params.outputFolder}/stats_files/ \\; || true
